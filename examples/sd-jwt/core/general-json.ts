...
import { GeneralJSON, SDJwtGeneralJSONInstance, SDJwtInstance } from '@sd-jwt/core'
...
;(async () => {
  ...
  console.log('flattenJSON(presentation): ', JSON.stringify(generalPresentationJSON.toJson(), null, 2))
