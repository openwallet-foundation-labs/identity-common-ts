...
;(async () => {
  ...
  const _valid = await sdjwt.validate(credential, { trustAnchors: ['trusted-issuer'] })
  ...
  const _presentation = await sdjwt.present<typeof claims>(credential, presentationFrame)
