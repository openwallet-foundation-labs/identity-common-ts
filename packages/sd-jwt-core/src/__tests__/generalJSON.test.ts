...
describe('GeneralJSON', () => {
      ...
      signatures: [
        {
          ...
          signature: 'n27NCtnuwytlBYtUNjgkesDP_7gN7bhaLhWNL4SWT6MaHsOjZ2ZMp987GgQRL6ZkLbJ7Cd3hlePHS84GBXPuvg',
          header: {
            disclosures: [
  ...
  test('add signature', async () => {
    ...
    await result.addSignature({ alg: 'ES256', typ: 'sd+jwt', kid: 'key-1' }, signer, 'key-1')
    ...
    expect(resultJson.signatures[1].protected).toEqual('eyJhbGciOiJFUzI1NiIsInR5cCI6InNkK2p3dCIsImtpZCI6ImtleS0xIn0')
  })
})
